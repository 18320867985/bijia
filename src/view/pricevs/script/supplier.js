...
export const supplier = {
    ...
    init() {
        ...
        $(function () {
            ...
            // 立即洽谈
            // 触发自定义的事件
            $(".v-modal").on("v-modal", function (e, bl, modaleEl, targetEl) {
                // 显示触发
                if (bl) {
                    console.log("v-modal:", bl, modaleEl, targetEl);
                    console.log(modaleEl);
                    console.log(targetEl);
                }
              
            });

            $(".__btn1").click(function () {
                $(".v-modal").VModal("show",this);
            });
